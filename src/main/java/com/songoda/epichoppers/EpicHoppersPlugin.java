...
public class EpicHoppersPlugin extends JavaPlugin implements EpicHoppers {
    ...
    private YamlDataFile hooksFile = new YamlDataFile(this, "hooks.yml");
        ...
        Bukkit.getScheduler().runTaskLater(this, () -> {
            if (storage.containsGroup("sync")) {
                for (StorageRow row : storage.getRowsByGroup("sync")) {
                    ...
                    Block block = blockLoc == null ? null : Methods.unserializeLocation(blockLoc).getBlock();
                    ...
                    Block black = blackLoc == null ? null : Methods.unserializeLocation(blackLoc).getBlock();
    ...
    private void saveToFile() {
        ...
        for (Hopper hopper : hopperManager.getHoppers().values()) {
            ...
            storage.saveItem("sync", new StorageItem("location", locationStr),
                    ...
                    new StorageItem("block", hopper.getSyncedBlock() == null ? null : Methods.serializeLocation(hopper.getSyncedBlock().getLocation())),
                    ...
                    new StorageItem("black", hopper.getFilter().getEndPoint() == null ? null : Methods.serializeLocation(hopper.getFilter().getEndPoint().getLocation())));
        }
    ...
    public ItemStack newHopperItem(Level level) {
        ...
        itemmeta.setDisplayName(Methods.formatName(level.getLevel(), true));
